...
BharatDub AI is an end-to-end video dubbing pipeline. Provide a local video or YouTube URL, choose the source and target languages, and the system can transcribe, translate, clone the speaker's voice, preserve background audio, synchronize the dubbed speech, and optionally perform lip-sync.

<p align="center">
  <img src="images/bharatdub_ai_logo.png" alt="BharatDub AI" width="180">
</p>
...
Hindi is the primary Indian-language focus of BharatDub AI and is configured as the default target language.

See LANGUAGE_SUPPORT.md for additional language information.
...
Obtain the source video

👥 Speaker Diarization

pyannote.audio

Detect who is speaking and when
...
Split dialogue into sentence segments
...
Mix generated and background audio

🎬 Media Processing

FFmpeg

Synchronize and export media
...
Enable or disable lip synchronization
...
If you do not need lip-sync, leave the option disabled and use the normal dubbing pipeline.
...
Results depend on how speech and background audio are mixed in the source video.
...
BharatDub AI can clone voices and modify visible lip movement.
