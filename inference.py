...
print("=" * 72)
print(" BharatDub AI - AI Video Dubbing Pipeline")
print(" Voice cloning • Translation • Background sound • Lip-sync")
print("=" * 72)
...
def main():
	...
	BharatDub = VideoDubbing(video_path, args.source_language, args.target_language, args.LipSync, not args.Bg_sound, args.whisper_model, os.getenv('Groq_TOKEN'), os.getenv('HF_TOKEN'))
